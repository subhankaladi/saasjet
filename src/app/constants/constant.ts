...
export const pricingPlans = [
  {
    name: 'Free',
    price: '$0',
    features: ['Basic Dashboard', 'Authentication', 'Open Source'],
    buttonText: 'Start Free',
    cardStyle: 'bg-white/5 border-white/10'
  },
  {
    name: 'Pro',
    price: '$9/mo',
    features: ['Advanced Dashboard', 'Email Automation', 'Analytics', 'Priority Support'],
    buttonText: 'Upgrade',
    cardStyle: 'bg-white/10 border-white/20'
  },
  {
    name: 'Lifetime',
    price: '$49',
    features: ['One-time payment', 'Updates forever', 'All modules included'],
